...
- Refund after cancellation: refunds are issued to the original payment method in USD; the refund completes {{refund_processing_time}}; the customer's bank may add 1–2 additional business days before the refund appears on the statement.
...
5. Refund After Cancellation — refunds are issued to the original payment method in USD, {{refund_processing_time}}; the bank may add 1–2 additional business days before the refund posts. {{ten_doanh_nghiep}} does NOT split or partially refund pre-dispatch cancellations.
6. Cancellation Fees — state literally that there are no cancellation, processing, or restocking fees for cancellations made before dispatch. Customers receive a full refund of the order amount paid.
...
- FORBIDDEN phrases (do NOT produce any variant of these — they contradict the cross-page rule or invent fees):
   ...
   * any refund window faster or slower than {{refund_processing_time}}.
...
- {{REFUND_AFTER}} — section 5 body (Refund After Cancellation). MUST include {{refund_processing_time}} + the 1–2 bank-day caveat.
