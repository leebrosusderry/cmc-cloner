...
- {{HEADING}} — page H1. 3–8 words, no full sentence, no trailing period. MAY include {{ten_web}} for brand voice (e.g. "About {{ten_web}}", "About Us — {{ten_web}}") OR use a generic editorial title (e.g. "Our Story", "Our Story and Mission", "About Us"). NEVER include {{ten_doanh_nghiep}} — the legal entity name does not belong in an H1; it is disclosed exactly once in the {{INTRO}} identity sentence per the CONCRETE IDENTITY POLICY above.
